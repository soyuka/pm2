...
module.exports = function(God) {
  ...
  God.killProcess = function(pid, cb) {
    ...
    try {
      //if we don't want to kill the tree we just SIGINT the process
      //sending SIGINT with the process group will kill all child processes but the detached ones
      process.kill(-pid, 'SIGINT'); //- act as as process group
    } catch(e) {
